function ballon_touche_montant = touche_montant_horz (pos)
  ...
  if(pos(2) <= poteaux(2,1) - R_BALLON || pos(2) >= poteaux(2,2) + R_BALLON)
    ballon_touche_montant = false;
  else
    ballon_touche_montant = calculer_distance(pos(1), poteaux(1,1), pos(3), HAUTEUR_BUT) <= R_BALLON;
  endif
